...
class MainActivity : BaseActivity<AppState>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.searchFab.setOnClickListener {
            ...
            dialogFragment.show(supportFragmentManager, BOTTOM_SHEET_FRAGMENT_DIALOG_TAG)
        }
    }
            ...
            is AppState.Success -> {
                ...
                if (dataModel == null || dataModel.isEmpty()) {
                    ...
                    if (adapter == null) {
                        ...
                        binding.mainActivityRecyclerview.adapter = RecyclerAdapter(onListItemClickListener, dataModel)
                    } else {
    ...
    companion object { private const val BOTTOM_SHEET_FRAGMENT_DIALOG_TAG = "74a54328-5d62-46bf-ab6b-cbf5fgt0-092395"
    }
}